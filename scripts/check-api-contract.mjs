...
const contracts = [
  ...
  ['POST', '/app/api/v1/account-lifecycle/cancellations', 'didi-passenger-h5', "'/app/api/v1/account-lifecycle/cancellations'"],
  ['GET', '/app/api/v1/account-lifecycle/operations/{operationNo}', 'didi-passenger-h5', '/account-lifecycle/operations/${encodeURIComponent(operationNo)}'],
  ['POST', '/app/api/v1/account-lifecycle/operations/{operationNo}/abort', 'didi-passenger-h5', '/abort`'],
  ['POST', '/app/api/v1/account-lifecycle/operations/{operationNo}/recheck', 'didi-passenger-h5', '/recheck`'],
  ['POST', '/app/api/v1/account-lifecycle/phone-changes/sms/send', 'didi-passenger-h5', '/account-lifecycle/phone-changes/sms/send'],
  ['POST', '/app/api/v1/account-lifecycle/phone-changes', 'didi-passenger-h5', "'/app/api/v1/account-lifecycle/phone-changes'"],
