...
import AiAssistantView from './features/ai/AiAssistantView.vue'
  ...
  <van-config-provider :theme-vars="themeVars">
    <div class="page page--passenger">
      ...
      <main class="gaode-home">
        ...
        <section v-else-if="passengerHomeTab !== 'ai'" class="passenger-tab-placeholder">
        ...
        <AiAssistantView
          v-show="passengerHomeTab === 'ai'"
          @back="passengerHomeTab = 'home'"
          @unauthorized="maybeDropToLogin"
        />
      </main>
