...
- 「福利」支持签到进度、签到和积分查询。
- AI 客服第一期功能已完成代码开发：乘客 H5 已接入真实会话创建／列表／切换／删除、历史消息、请求状态对账、文字 SSE、单端点续接、地点与核查含义选择、路线卡和过期摘要展示；地图事实及完整路线由后端裁决，前端不自行恢复过期路线。开放式收费站多方案不纳入第一期，暂不开发；第一期仍待运行环境与端到端验收，开发完成不等于已上线。
...
- [AI 客服指定途经点路线规划 PRD](../didi-taxi/二期功能/乘客端_AI客服_指定途经点路线规划_PRD.md) / [TECH](../didi-taxi/二期功能/乘客端_AI客服_指定途经点路线规划_TECH.md) / [API](../didi-taxi/二期功能/乘客端_AI客服_指定途经点路线规划_API.md) / [TEST](../didi-taxi/二期功能/乘客端_AI客服_指定途经点路线规划_TEST.md)
